...
from imtd.algo.analysis.dfg_functions import edge_case_id_mapping, case_id_trace_index_mapping, generate_nx_graph_from_event_log


CASE_ID_KEY = 'case:concept:name'

def test_edge_case_id_mapping():
    event_log = EventLog([])
    m = edge_case_id_mapping(event_log)
    assert len(m) == 0
