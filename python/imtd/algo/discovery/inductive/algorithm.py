...
from imtd.algo.discovery.inductive.variants.imf import IMFUVCL
...
def apply(obj: Union[EventLog, pd.DataFrame, DFG, UVCL], parameters: Optional[Dict[Any, Any]] = None,
