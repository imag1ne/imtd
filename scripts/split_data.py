...
def split_event_log(event_log):
    desirable_event_log = pm4py.filter_trace_attribute_values(event_log, DEFAULT_NAME_KEY, ['W_Call incomplete files'], False)
    undesirable_event_log = pm4py.filter_trace_attribute_values(event_log, DEFAULT_NAME_KEY, ['W_Call incomplete files'])
